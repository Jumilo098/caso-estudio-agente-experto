...
<div class="card">
<h3 style="margin:0 0 6px">🗂️ Explorar y descargar archivo por archivo</h3>
<p style="margin:6px 0">Todo el material también está navegable en GitHub: entra a una carpeta, abre
cualquier archivo para leerlo en el navegador y descárgalo individualmente con el botón
<i>Download raw file</i> (⬇) de la esquina superior derecha del archivo.</p>
<p style="margin:12px 0"><a href="https://github.com/Jumilo098/caso-estudio-agente-experto" target="_blank"
  style="display:inline-block;background:var(--ink-1);color:var(--plane);text-decoration:none;border-radius:8px;padding:10px 18px;font-weight:600">
  Explorar el repositorio en GitHub</a></p>
<p style="margin:10px 0 4px"><b>Accesos directos:</b></p>
<ul style="margin:4px 0">
<li><a href="https://github.com/Jumilo098/caso-estudio-agente-experto/tree/main/base_conocimiento" target="_blank">base_conocimiento/</a>
 — el paquete navegable (sin los reportes; esos van en el ZIP).</li>
<li><a href="https://github.com/Jumilo098/caso-estudio-agente-experto/tree/main/src" target="_blank">src/</a>
 — los 7 Expert Advisors en MQL5, comentados en español para estudiar línea a línea.</li>
<li><a href="https://github.com/Jumilo098/caso-estudio-agente-experto/blob/main/datos/resultados.json" target="_blank">datos/resultados.json</a>
 — métricas de todas las corridas ·
<a href="https://github.com/Jumilo098/caso-estudio-agente-experto/blob/main/datos/sweetspot.json" target="_blank">datos/sweetspot.json</a>
 — la matriz del examen final.</li>
<li><a href="https://github.com/Jumilo098/caso-estudio-agente-experto/blob/main/docs/BUGS.md" target="_blank">docs/BUGS.md</a>
 — la batería completa de bugs con detalle técnico.</li>
</ul>
